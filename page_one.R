...
main_panel <- mainPanel(
  ...
  p("These different charts were used to help differentiate the different",
    strong("movie genres and their average bechdel rating"),
    ". We allow our users to pick",
    "what type of plot they want to see based on their",
    "opinion of what they think is best to show this type of data. For the",
    strong("pie"), "graph, the larger the",
    "slice, the higher the average bechdel rating it has. For the",
    strong("bar and point"), "graphs, the higher",
    "the data is, the more likely it is for the genre to",
    "pass the bechdel test. We decided",
    "to include these charts so that we can see which movie genre is",
    "most likely to pass the bechdel test by comparing",
    "the general sizes or heights of",
    ...
    "bigger than musicals by 0.02, we can deduce that",
    strong("romantic comedies"), " is",
    "the genre most likely to", strong("pass the bechdel test"),
